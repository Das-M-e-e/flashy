...
const translations: Record<Lang, Record<string, string>> = {
  de: {
    ...
    "card.imageWorking": "Bild wird verarbeitet …",
    "card.imageTooLarge": "Das Bild ist auch nach dem Verkleinern zu groß (max. 1 MB). Bitte ein kleineres verwenden.",
    "card.imageFailed": "Bild konnte nicht eingefügt werden.",
  ...
  en: {
    ...
    "card.imageWorking": "Processing image …",
    "card.imageTooLarge": "The image is still too large after resizing (max. 1 MB). Please use a smaller one.",
    "card.imageFailed": "Could not insert the image.",
